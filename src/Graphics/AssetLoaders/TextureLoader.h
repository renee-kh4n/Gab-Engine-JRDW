...
namespace gbe {
	namespace gfx {
		class TextureLoader : public asset::AssetLoader<asset::Texture, asset::data::TextureData> {
		private:
		...
		protected:
			bool LoadAsset_(asset::Texture* asset, asset::data::TextureData* data) override;
			void UnLoadAsset_(asset::Texture* asset, asset::data::TextureData* data) override;
		public:
